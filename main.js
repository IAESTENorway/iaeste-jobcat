...
{
	if (region._.I === region.ah.I)
	{
		return 'on line ' + region._.I;
	}
	return 'on lines ' + region._.I + ' through ' + region.ah.I;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { a0: 'hidden', aM: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { a0: 'mozHidden', aM: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { a0: 'msHidden', aM: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { a0: 'webkitHidden', aM: 'webkitvisibilitychange' }
		: { a0: 'hidden', aM: 'visibilitychange' };
}
...
var $author$project$Types$Model = F3(
	function (allJobs, currentJobs, filterModel) {
		return {ac: allJobs, H: currentJobs, U: filterModel};
	});
var $elm$json$Json$Decode$decodeString = _Json_runOnString;
var $author$project$Types$Job = function (refNo) {
				...
				return function (airport) {
					return function (employer) {
						return function (employees) {
							return function (hoursWeekly) {
								return function (hoursDaily) {
									return function (faculties) {
										return function (special) {
											return function (trainingReq) {
												return function (otherReq) {
													return function (workkind) {
														return function (weeksMin) {
															return function (weeksMax) {
																return function (to) {
																	return function (from) {
																		return function (study_begin) {
																			return function (study_middle) {
																				return function (study_end) {
																					return function (languages) {
																						return function (currency) {
																							return function (payment) {
																								return function (paymentFreq) {
																									return function (deduction) {
																										return function (livingcost) {
																											return function (livingcostFreq) {
																												return function (idoffer) {
																													return {aH: airport, aL: business, O: country, aR: currency, aS: deduction, aW: employees, aX: employer, a_: faculties, a$: from, a1: hoursDaily, a2: hoursWeekly, a3: idoffer, a9: languages, ba: livingcost, bb: livingcostFreq, bh: otherReq, bi: payment, bj: paymentFreq, bl: refNo, bn: special, bo: study_begin, bp: study_end, bq: study_middle, bt: to, bv: trainingReq, bC: weeksMax, bD: weeksMin, bE: workkind, bF: workplace};
																												};
																											};
																										};
																									};
...
var $author$project$JSON$facultyDecoder = function () {
	...
	return $NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$resolve(
		A4(
			...
			'N/A',
			$elm$json$Json$Decode$succeed(toListDecoder)));
}();
var $author$project$Types$LanguageList = F5(
	function (tuple1, connector1, tuple2, connector2, tuple3) {
		return {aO: connector1, aP: connector2, bw: tuple1, bx: tuple2, by: tuple3};
	});
var $author$project$Types$LanguageTuple = F2(
	function (language, knowledgeLevel) {
		return {a7: knowledgeLevel, a8: language};
	});
var $author$project$JSON$langTupleDecoder = function (_v0) {
	var langfield = _v0.a;
	var levelField = _v0.b;
	return A4(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
		levelField,
		$elm$json$Json$Decode$string,
		...
		A4(
			...
			$elm$json$Json$Decode$string,
			'N/A',
			$elm$json$Json$Decode$succeed($author$project$Types$LanguageTuple)));
};
...
var $author$project$JSON$languageDecoder = A2(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
	$author$project$JSON$langTupleDecoder(
		_Utils_Tuple2('Language3', 'Language3Level')),
	A3(
		...
		A2(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
			$author$project$JSON$langTupleDecoder(
				_Utils_Tuple2('Language2', 'Language2Level')),
			A3(
				$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
				'Language1or',
				$elm$json$Json$Decode$string,
				A2(
					$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
					$author$project$JSON$langTupleDecoder(
						_Utils_Tuple2('Language1', 'Language1Level')),
					$elm$json$Json$Decode$succeed($author$project$Types$LanguageList))))));
var $author$project$JSON$jobDecoder = A4(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
	'idoffer',
	$elm$json$Json$Decode$string,
	'N/A',
				...
				A4(
					...
					A4(
						...
						A4(
							...
							A2(
								$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
								$author$project$JSON$languageDecoder,
								A4(
									$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
									'StudyCompleted_End',
									$elm$json$Json$Decode$string,
																...
																A4(
																	...
																	A4(
																		...
																		A4(
																			...
																			A2(
																				$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$custom,
																				$author$project$JSON$facultyDecoder,
																				A4(
																					$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
																					'HoursDaily',
																					$elm$json$Json$Decode$string,
																										...
																										A4(
																											...
																											A4(
																												...
																												A4(
																													...
																													$elm$json$Json$Decode$string,
																													'N/A',
																													$elm$json$Json$Decode$succeed($author$project$Types$Job))))))))))))))))))))))))))))));
...
var $author$project$JSON$decodeJobs = function (jsonString) {
	return A2(
		$elm$core$Result$withDefault,
		_List_Nil,
		A2(
			$elm$json$Json$Decode$decodeString,
			$elm$json$Json$Decode$list($author$project$JSON$jobDecoder),
			jsonString));
};
var $author$project$Types$FilterModel = F4(
	function (faculty, facMenu, country, countryMenu) {
		return {O: country, R: countryMenu, S: facMenu, T: faculty};
	});
...
var $kirchner$elm_selectize$Selectize$Selectize$closed = F3(
	function (id, toLabel, entries) {
		...
		return {k: labeledEntries, P: _List_Nil, p: id, J: 0, w: $elm$core$Maybe$Nothing, bg: false, Q: false, aw: '', Y: 0, j: $elm$core$Maybe$Nothing};
	});
...
var $author$project$CountryFilter$countries = function (jobList) {
...
var $author$project$CountryFilter$initMenu = function (jobList) {
	return A3(
		...
		A2(
			...
			$author$project$CountryFilter$countries(jobList)));
};
...
var $author$project$FacultyFilter$faculties = function (jobList) {
	return $elm$core$Set$toList(
		$elm$core$Set$fromList(
...
var $author$project$FacultyFilter$initMenu = function (jobList) {
	return A3(
		$kirchner$elm_selectize$Selectize$closed,
		'faculty-filter',
		$elm$core$Basics$identity,
		A2(
			$elm$core$List$map,
			$kirchner$elm_selectize$Selectize$entry,
			$author$project$FacultyFilter$faculties(jobList)));
};
var $author$project$Filters$initFilters = function (jobList) {
	return A4(
		$author$project$Types$FilterModel,
		$elm$core$Maybe$Nothing,
		$author$project$FacultyFilter$initMenu(jobList),
		$elm$core$Maybe$Nothing,
		$author$project$CountryFilter$initMenu(jobList));
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (flags) {
	var jobs = $author$project$JSON$decodeJobs(flags.am);
	return _Utils_Tuple2(
		A3(
			$author$project$Types$Model,
			jobs,
			jobs,
			$author$project$Filters$initFilters(jobs)),
...
var $author$project$Types$FilterMsg = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Main$applyFilter = F2(
	function (filterPredicate, model) {
		return _Utils_update(
			model,
			{
				H: A2($elm$core$List$filter, filterPredicate, model.H)
			});
	});
var $author$project$Main$filterByCountry = F2(
	function (filterModel, model) {
		var _v0 = filterModel.O;
		if (!_v0.$) {
			var country = _v0.a;
			return A2(
				$author$project$Main$applyFilter,
				function (job) {
					return _Utils_eq(job.O, country);
				},
				model);
		} else {
			return model;
...
var $author$project$Main$filterByFaculty = F2(
	function (filterModel, model) {
		var _v0 = filterModel.T;
		if (!_v0.$) {
			var faculty = _v0.a;
			return A2(
				$author$project$Main$applyFilter,
				function (job) {
					return A2($elm$core$List$member, faculty, job.a_);
				},
				model);
		} else {
			return model;
...
var $author$project$Main$runFiltering = F2(
	function (model, filterModel) {
		return A2(
			$author$project$Main$filterByCountry,
			filterModel,
			A2(
				$author$project$Main$filterByFaculty,
				filterModel,
				_Utils_update(
					model,
					{H: model.ac})));
	});
var $author$project$Types$CountryMsg = function (a) {
	return {$: 1, a: a};
};
var $author$project$Filters$mapCountryMsg = function (_v0) {
	var model = _v0.a;
	var msg = _v0.b;
	return _Utils_Tuple2(
		model,
		A2(
			...
			function (a) {
				return $author$project$Types$CountryMsg(a);
			},
			msg));
};
var $author$project$Types$FacultyMsg = function (a) {
	return {$: 0, a: a};
};
var $author$project$Filters$mapFacultyMsg = function (_v0) {
	var model = _v0.a;
	var msg = _v0.b;
	return _Utils_Tuple2(
		model,
		A2(
			$elm$core$Platform$Cmd$map,
			function (a) {
				return $author$project$Types$FacultyMsg(a);
			},
			msg));
};
var $author$project$Types$CountryMenuMsg = function (a) {
	return {$: 0, a: a};
};
var $author$project$Types$SelectCountry = function (a) {
	return {$: 1, a: a};
};
var $author$project$CountryFilter$andDo = F2(
	function (cmd, _v0) {
		var model = _v0.a;
		var cmds = _v0.b;
		return _Utils_Tuple2(
...
var $kirchner$elm_selectize$Selectize$Selectize$zipFirst = function (zipList) {
	var front = zipList.n;
	var current = zipList.e;
	var back = zipList.g;
	var currentTop = zipList.h;
	if (current.a.$ === 1) {
		if (!back.b) {
			return $elm$core$Maybe$Nothing;
		} else {
			...
			return $kirchner$elm_selectize$Selectize$Selectize$zipFirst(
				{
					g: rest,
					e: next,
					h: currentTop + current.b,
					n: A2($elm$core$List$cons, current, front)
				});
		}
	} else {
...
var $kirchner$elm_selectize$Selectize$Selectize$fromList = F2(
	function (entries, entryHeights) {
		...
		if (_v0.a.b && _v0.b.b) {
			...
			return $kirchner$elm_selectize$Selectize$Selectize$zipFirst(
				{
					g: A2($kirchner$elm_selectize$Selectize$Selectize$zip, restEntries, restHeights),
					e: _Utils_Tuple2(firstEntry, firstHeight),
					h: 0,
					n: _List_Nil
				});
		} else {
...
var $kirchner$elm_selectize$Selectize$Selectize$fromListWithFilter = F3(
	function (query, entries, entryHeights) {
		...
		if (filtered.b) {
			...
			var rest = filtered.b;
			return $kirchner$elm_selectize$Selectize$Selectize$zipFirst(
				{g: rest, e: first, h: 0, n: _List_Nil});
		} else {
			return $elm$core$Maybe$Nothing;
		}
	});
...
var $kirchner$elm_selectize$Selectize$Selectize$reset = function (state) {
	return _Utils_update(
		state,
		{w: $elm$core$Maybe$Nothing, bg: false, aw: '', j: $elm$core$Maybe$Nothing});
};
...
var $kirchner$elm_selectize$Selectize$Selectize$scrollToKeyboardFocus = F3(
	function (id, scrollTop, _v0) {
		...
		if (!_v1.$) {
			...
			var y = (_Utils_cmp(top, scrollTop) < 0) ? top : ((_Utils_cmp(top + height, scrollTop + state.J) > 0) ? ((top + height) - state.J) : scrollTop);
	...
	if (current.a.$ === 1) {
		if (!front.b) {
			...
			return $kirchner$elm_selectize$Selectize$Selectize$zipReverseFirst(
				{
					g: A2($elm$core$List$cons, current, back),
					e: previous,
					h: currentTop - previous.b,
					n: rest
				});
		}
	} else {
...
var $kirchner$elm_selectize$Selectize$Selectize$updateKeyboardFocus = F3(
	function (select, movement, state) {
		var newZipList = function () {
			switch (movement) {
				case 0:
					return A2($elm$core$Maybe$map, $kirchner$elm_selectize$Selectize$Selectize$zipPrevious, state.j);
				case 1:
					return A2($elm$core$Maybe$map, $kirchner$elm_selectize$Selectize$Selectize$zipNext, state.j);
				default:
					return state.j;
			}
		}();
		...
		switch (msg.$) {
			...
			case 1:
				...
				var newZipList = A2(
					...
					A2($kirchner$elm_selectize$Selectize$Selectize$fromList, state.k, heights.k));
				var top = A2(
					$elm$core$Maybe$withDefault,
					0,
					A2(
				...
				return _Utils_Tuple3(
					_Utils_update(
						state,
						{P: heights.k, J: heights.bc, w: $elm$core$Maybe$Nothing, bg: true, aw: '', Y: scrollTop, j: newZipList}),
					A2($kirchner$elm_selectize$Selectize$Selectize$scroll, state.p, top - ((heights.bc - height) / 2)),
					$elm$core$Maybe$Nothing);
			case 2:
				return state.Q ? _Utils_Tuple3(state, $elm$core$Platform$Cmd$none, $elm$core$Maybe$Nothing) : _Utils_Tuple3(
			...
			case 3:
				return _Utils_Tuple3(
					state,
					$kirchner$elm_selectize$Selectize$Selectize$focus(state.p),
					$elm$core$Maybe$Nothing);
			case 4:
				return _Utils_Tuple3(
					state,
					$kirchner$elm_selectize$Selectize$Selectize$blur(state.p),
					$elm$core$Maybe$Nothing);
			case 5:
			...
			case 6:
				var newQuery = msg.a;
				var newZipList = A3($kirchner$elm_selectize$Selectize$Selectize$fromListWithFilter, newQuery, state.k, state.P);
				return _Utils_Tuple3(
					_Utils_update(
						state,
						{w: $elm$core$Maybe$Nothing, aw: newQuery, j: newZipList}),
					A2($kirchner$elm_selectize$Selectize$Selectize$scroll, state.p, 0),
					$elm$core$Maybe$Just(
						select($elm$core$Maybe$Nothing)));
			case 7:
				var newFocus = msg.a;
			...
			case 8:
				var a = msg.a;
				var selection = A2($kirchner$elm_selectize$Selectize$Selectize$selectFirst, state.k, a);
				return _Utils_Tuple3(
					$kirchner$elm_selectize$Selectize$Selectize$reset(state),
					$elm$core$Platform$Cmd$none,
					$elm$core$Maybe$Just(
			...
			case 10:
				var selection = A2(
					...
					$kirchner$elm_selectize$Selectize$Selectize$selectFirst(state.k),
					A2($elm$core$Maybe$andThen, $kirchner$elm_selectize$Selectize$Selectize$currentEntry, state.j));
				return _Utils_Tuple3(
					$kirchner$elm_selectize$Selectize$Selectize$reset(state),
					$kirchner$elm_selectize$Selectize$Selectize$blur(state.p),
					$elm$core$Maybe$Just(
...
var $author$project$CountryFilter$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var selectizeMsg = msg.a;
			var _v1 = A4($kirchner$elm_selectize$Selectize$update, $author$project$Types$SelectCountry, model.O, model.R, selectizeMsg);
			var newMenu = _v1.a;
			var menuCmd = _v1.b;
			var maybeMsg = _v1.c;
			var cmd = A2($elm$core$Platform$Cmd$map, $author$project$Types$CountryMenuMsg, menuCmd);
			...
			if (!maybeMsg.$) {
				...
				return A2(
					$author$project$CountryFilter$andDo,
					cmd,
					A2($author$project$CountryFilter$update, nextMsg, newModel));
			} else {
...
var $author$project$Types$FacMenuMsg = function (a) {
	return {$: 0, a: a};
};
var $author$project$Types$SelectFaculty = function (a) {
	return {$: 1, a: a};
};
var $author$project$FacultyFilter$andDo = F2(
	function (cmd, _v0) {
		var model = _v0.a;
		var cmds = _v0.b;
		return _Utils_Tuple2(
...
var $author$project$FacultyFilter$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var selectizeMsg = msg.a;
			var _v1 = A4($kirchner$elm_selectize$Selectize$update, $author$project$Types$SelectFaculty, model.T, model.S, selectizeMsg);
			var newMenu = _v1.a;
			var menuCmd = _v1.b;
			var maybeMsg = _v1.c;
			var cmd = A2($elm$core$Platform$Cmd$map, $author$project$Types$FacMenuMsg, menuCmd);
			var newModel = _Utils_update(
				model,
				{S: newMenu});
			if (!maybeMsg.$) {
				var nextMsg = maybeMsg.a;
				return A2(
					$author$project$FacultyFilter$andDo,
					cmd,
					A2($author$project$FacultyFilter$update, nextMsg, newModel));
			} else {
				return _Utils_Tuple2(newModel, cmd);
			}
		} else {
...
var $author$project$Filters$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var selectizeMsg = msg.a;
			return $author$project$Filters$mapFacultyMsg(
				A2($author$project$FacultyFilter$update, selectizeMsg, model));
		} else {
			var selectizeMsg = msg.a;
			return $author$project$Filters$mapCountryMsg(
				A2($author$project$CountryFilter$update, selectizeMsg, model));
		}
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var msgType = msg.a;
				var _v1 = A2($author$project$Filters$update, msgType, model.U);
				var fModel = _v1.a;
				var filterCmd = _v1.b;
				var updModel = A2($author$project$Main$runFiltering, model, fModel);
				return _Utils_Tuple2(
					_Utils_update(
						updModel,
						{U: fModel}),
					A2(
						$elm$core$Platform$Cmd$map,
						function (a) {
							return $author$project$Types$FilterMsg(a);
						},
						filterCmd));
		}
	});
...
var $author$project$ViewGenerator$boolStudyLvl = function (value) {
	return value === 'Y';
};
...
var $author$project$ViewGenerator$determineStudyLvl = F3(
...
var $author$project$ViewGenerator$formatLanguageTuple = F2(
	function (connector, languageTuple) {
		var _v0 = languageTuple.a8;
		if (_v0 === 'N/A') {
			return '';
		} else {
			return $elm$core$String$toLower(
				A2($elm$core$Maybe$withDefault, '', connector)) + (' ' + (languageTuple.a8 + (' : ' + languageTuple.a7)));
		}
	});
var $author$project$ViewGenerator$formatJobLanguages = function (_v0) {
	var tuple1 = _v0.bw;
	var connector1 = _v0.aO;
	var tuple2 = _v0.bx;
	var connector2 = _v0.aP;
	var tuple3 = _v0.by;
	return A2($author$project$ViewGenerator$formatLanguageTuple, $elm$core$Maybe$Nothing, tuple1) + (' ' + (A2(
		$author$project$ViewGenerator$formatLanguageTuple,
		$elm$core$Maybe$Just(connector1),
		tuple2) + (' ' + A2(
		$author$project$ViewGenerator$formatLanguageTuple,
		$elm$core$Maybe$Just(connector2),
		tuple3))));
};
...
var $author$project$ViewGenerator$buildFullJobElement = function (job) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('responsive-table table-1')
							]),
						_List_fromArray(
							[
								A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('Arbeidsuker')
													])),
												A2(
												$elm$html$Html$th,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text('Arbeidsperiode')
													])),
												A2(
												$elm$html$Html$th,
												_List_Nil,
												...
												_List_fromArray(
													[
														$elm$html$Html$text('Leve- og bokostnader')
													])),
												A2(
												$elm$html$Html$th,
												_List_Nil,
												...
												_List_fromArray(
													[
														$elm$html$Html$text('Tidl. arb.erfaring')
													]))
											]))
									])),
								A2(
											...
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text(
														A3(
															$author$project$ViewGenerator$determineStudyLvl,
															$author$project$ViewGenerator$boolStudyLvl(job.bo),
															$author$project$ViewGenerator$boolStudyLvl(job.bq),
															$author$project$ViewGenerator$boolStudyLvl(job.bp)))
													])),
												A2(
												$elm$html$Html$td,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text(job.bi + (' ' + job.aR))
													])),
												A2(
												$elm$html$Html$td,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text(job.bD + (' - ' + (job.bC + ' uker')))
													])),
												A2(
												$elm$html$Html$td,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text(job.a$ + (' til ' + job.bt))
													])),
												A2(
												$elm$html$Html$td,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text(
														$author$project$ViewGenerator$formatJobLanguages(job.a9))
													])),
												A2(
												$elm$html$Html$td,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text(job.aR + (' ' + (job.ba + ('/' + job.bb))))
													])),
												A2(
												$elm$html$Html$td,
												_List_Nil,
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('table-wrapper'),
						A2($elm$html$Html$Attributes$attribute, 'id', 'job-table-2')
					]),
				_List_fromArray(
					[
						A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('Arb.timer i uken')
													])),
												A2(
												$elm$html$Html$th,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text('Arb.timer daglig')
													])),
												A2(
												$elm$html$Html$th,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text('Skatt av lønn')
													])),
												A2(
												$elm$html$Html$th,
												_List_Nil,
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text(job.a2 + ' timer i uken')
													])),
												A2(
												$elm$html$Html$td,
												_List_Nil,
												_List_fromArray(
													[
														$elm$html$Html$text(job.a1 + ' timer dagen')
													])),
												A2(
												$elm$html$Html$td,
												_List_Nil,
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('btn orange lighten-2 waves-effect see-job-btn max-width right'),
								$elm$html$Html$Attributes$href('https://script.google.com/macros/s/AKfycbzisKUfZLZDqVjrYCXsY-8WeqcT-WVTdP09aI3mmJ5Fy3-CcNU/exec')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Gå til jobben')
							]))
					]))
			]));
};
...
var $author$project$ViewGenerator$buildJobPreviewElement = function (job) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('collapsible-header row waves-effect')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('country col s2')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$src('res/flags/' + (job.O + '.png'))
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('')
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('employer col s7')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(job.aX)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('faculty col s2 max-width')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								A2($elm$core$String$join, ', ', job.a_))
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('arrow col s1 right')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$src('res/img/arrow.svg')
									]),
								_List_Nil)
							]))
					])),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('work-desc')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Jobbeskrivelse')
									])),
								A2(
								$elm$html$Html$p,
								_List_Nil,
						...
						$author$project$ViewGenerator$buildFullJobElement(job)
					]))
			]));
};
var $author$project$ViewGenerator$buildDivs = function (list) {
	if (list.b) {
		var head = list.a;
		var tail = list.b;
		return A2(
			$elm$core$List$cons,
			$author$project$ViewGenerator$buildJobPreviewElement(head),
			$author$project$ViewGenerator$buildDivs(tail));
	} else {
		return _List_Nil;
	}
};
	...
	function (config, keyboardFocused, mouseFocus, e) {
		var _v0 = function () {
			if (!e.$) {
				...
				var title = e.a;
				return config.aT(title);
			}
		}();
		var attributes = _v0.ad;
		var children = _v0.af;
		...
		var menuAttrs = _Utils_ap(
			_List_fromArray(
				[
					...
					$kirchner$elm_selectize$Selectize$Selectize$menuId(state.p)),
			...
			$kirchner$elm_selectize$Selectize$Selectize$noOp(config.bc));
		var _v0 = state.j;
		if (_v0.$ === 1) {
			return A2(
				$elm$html$Html$div,
				_Utils_ap(
					$kirchner$elm_selectize$Selectize$Selectize$noOp(config.aQ),
					_List_fromArray(
						[
				...
				_List_fromArray(
					[
						A4(config.a6, state.p, selectionText, state.aw, state.bg),
						A2(
						$elm$html$Html$div,
						menuAttrs,
						_List_fromArray(
							[
								A2(
								$elm$html$Html$ul,
								$kirchner$elm_selectize$Selectize$Selectize$noOp(config.bz),
								A2(
									$elm$core$List$map,
									A2(
										$elm$core$Basics$composeR,
								...
								$elm$core$List$concat(
									_List_fromArray(
										[
											...
											A3($kirchner$elm_selectize$Selectize$Selectize$viewEntries, config, state, zipList.n)),
											_List_fromArray(
											[
												A3($kirchner$elm_selectize$Selectize$Selectize$viewCurrentEntry, config, state, zipList.e)
											]),
											A3($kirchner$elm_selectize$Selectize$Selectize$viewEntries, config, state, zipList.g)
										])))
							]))
					]));
		}
		...
		var inputAttrs = $elm$core$List$concat(
			_List_fromArray(
				[
					...
					[
						$elm$html$Html$Attributes$placeholder(config.bk)
					]) : _List_fromArray(
					[
						$elm$html$Html$Attributes$value(config.bk)
					])) : _List_fromArray(
					[
...
var $author$project$CountryFilter$clearButton = $elm$core$Maybe$Just(
	A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$CountryFilter$styledInput = $kirchner$elm_selectize$Selectize$autocomplete(
	{
		aJ: F2(
		...
		aN: $author$project$CountryFilter$clearButton,
		bk: 'Velg eller skriv inn et land',
...
var $kirchner$elm_selectize$Selectize$viewConfig = function (config) {
	return {aQ: config.aQ, aT: config.aT, aY: config.aY, a6: config.a6, bc: config.bc, bz: config.bz};
};
var $author$project$CountryFilter$viewConfig = $kirchner$elm_selectize$Selectize$viewConfig(
	{
		aQ: _List_fromArray(
			[
		...
		a6: $author$project$CountryFilter$styledInput,
		bc: _List_fromArray(
			[
...
var $author$project$CountryFilter$countryDropdown = function (filterModel) {
	return A2(
		$elm$html$Html$map,
		$author$project$Types$CountryMenuMsg,
		A3($kirchner$elm_selectize$Selectize$view, $author$project$CountryFilter$viewConfig, filterModel.O, filterModel.R));
};
var $author$project$FacultyFilter$clearButton = $elm$core$Maybe$Just(
	A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$FacultyFilter$styledInput = $kirchner$elm_selectize$Selectize$autocomplete(
	{
		aJ: F2(
			function (sthSelected, open) {
				return _List_fromArray(
		...
		aN: $author$project$FacultyFilter$clearButton,
		bk: 'Velg eller skriv inn et studiefelt',
		bu: $elm$core$Maybe$Just(
			function (open) {
				return A2(
					$elm$html$Html$i,
...
var $author$project$FacultyFilter$viewConfig = $kirchner$elm_selectize$Selectize$viewConfig(
	{
		aQ: _List_fromArray(
			[
				$elm$html$Html$Attributes$class('selectize__container')
		...
		aY: F3(
			function (faculty, mouseFocused, keyboardFocused) {
				return {
					ad: _List_fromArray(
						[
							$elm$html$Html$Attributes$class('selectize__item'),
					...
					af: _List_fromArray(
						[
							$elm$html$Html$text(faculty)
						])
				};
			}),
		a6: $author$project$FacultyFilter$styledInput,
		bc: _List_fromArray(
			[
				$elm$html$Html$Attributes$class('selectize__menu')
			]),
...
var $author$project$FacultyFilter$facultyDropdown = function (filterModel) {
	return A2(
		$elm$html$Html$map,
		$author$project$Types$FacMenuMsg,
		A3($kirchner$elm_selectize$Selectize$view, $author$project$FacultyFilter$viewConfig, filterModel.T, filterModel.S));
};
var $author$project$Filters$filterDropdowns = function (filterModel) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$FacultyFilter$facultyDropdown(filterModel)),
				A2(
				$elm$html$Html$map,
				function (a) {
					return $author$project$Types$CountryMsg(a);
				},
				$author$project$CountryFilter$countryDropdown(filterModel))
			]));
};
var $author$project$Main$buildFilterView = function (model) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Filtrer jobber')
							]))
					])),
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						$author$project$Filters$filterDropdowns(model.U))
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('z-depth-2')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('logo-btn')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('https://iaeste.no')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												...
												A2($elm$html$Html$Attributes$attribute, 'src', 'res/img/logo.svg')
											]),
										_List_Nil)
									]))
							]))
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$attribute, 'id', 'top-text')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('IAESTEs praktikantplasser')
							])),
						A2(
						$elm$html$Html$ul,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('collapsible popout filter-class'),
								A2($elm$html$Html$Attributes$attribute, 'data-collapsible', 'accordion')
							]),
						_List_fromArray(
							[
								$author$project$Main$buildFilterView(model)
							])),
						A2(
						$elm$html$Html$ul,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('collapsible popout'),
								A2($elm$html$Html$Attributes$attribute, 'data-collapsible', 'accordion')
							]),
						$author$project$ViewGenerator$buildDivs(model.H))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$attribute, 'src', 'res/img/hspHvit2.png')
							]),
						_List_Nil)
					]))
			]));
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{a5: $author$project$Main$init, br: $author$project$Main$subscriptions, bA: $author$project$Main$update, bB: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'json', $elm$json$Json$Decode$string)))(0)}});}(this));