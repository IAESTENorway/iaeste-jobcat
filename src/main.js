...
var _user$project$Types$LanguageTuple = F2(
	function (a, b) {
		return {language: a, knowledgeLevel: b};
	});
var _user$project$Types$Job = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _user$project$Types$FilterMsg = function (a) {
...
var _user$project$Json$langTupleDecoder = function (_p0) {
	...
	return A4(
		...
		A4(
			...
			_elm_lang$core$Json_Decode$string,
			'N/A',
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Types$LanguageTuple)));
};
var _user$project$Json$languageDecoder = A2(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
	_user$project$Json$langTupleDecoder(
		{ctor: '_Tuple2', _0: 'Language3', _1: 'Language3Level'}),
	A3(
		...
		A2(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
			_user$project$Json$langTupleDecoder(
				{ctor: '_Tuple2', _0: 'Language2', _1: 'Language2Level'}),
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'Language1or',
				_elm_lang$core$Json_Decode$string,
				A2(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
					_user$project$Json$langTupleDecoder(
						{ctor: '_Tuple2', _0: 'Language1', _1: 'Language1Level'}),
...
var _user$project$Json$decodeJobs = function (jsonString) {
	return A2(
		...
		A2(
			...
			_elm_lang$core$Json_Decode$list(_user$project$Json$jobDecoder),
			jsonString));
};

var _user$project$ViewGenerator$formatLanguageTuple = F2(
	function (connector, languageTuple) {
		var _p0 = languageTuple.language;
		if (_p0 === 'N/A') {
			return '';
		} else {
			return A2(
				...
				_elm_lang$core$String$toLower(
					A2(_elm_lang$core$Maybe$withDefault, '', connector)),
				A2(
					_elm_lang$core$Basics_ops['++'],
					' ',
					A2(
						...
						A2(_elm_lang$core$Basics_ops['++'], ' : ', languageTuple.knowledgeLevel))));
		}
	});
var _user$project$ViewGenerator$formatJobLanguages = function (_p1) {
	var _p2 = _p1;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		A2(_user$project$ViewGenerator$formatLanguageTuple, _elm_lang$core$Maybe$Nothing, _p2.tuple1),
		A2(
			_elm_lang$core$Basics_ops['++'],
			' ',
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(
					_user$project$ViewGenerator$formatLanguageTuple,
					_elm_lang$core$Maybe$Just(_p2.connector1),
					_p2.tuple2),
				A2(
					_elm_lang$core$Basics_ops['++'],
					' ',
					A2(
						_user$project$ViewGenerator$formatLanguageTuple,
						_elm_lang$core$Maybe$Just(_p2.connector2),
						_p2.tuple3)))));
};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('table-wrapper'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('responsive-table table-1'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Arbeidssted'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Årstrinn'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Lønn'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Arbeidsuker'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Arbeidsperiode'),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Språk'),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('Leve- og bokostnader'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																		...
																		_1: {
																			...
																			_0: A2(
																				...
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html$text('Tidl. arb.erfaring'),
																					_1: {ctor: '[]'}
																				}),
																			_1: {ctor: '[]'}
																		}
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(job.workplace),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{ctor: '[]'},
														{
															...
															_0: _elm_lang$html$Html$text(
																A3(
																	_user$project$ViewGenerator$determineStudyLvl,
																	_user$project$ViewGenerator$boolStudyLvl(job.study_begin),
																	_user$project$ViewGenerator$boolStudyLvl(job.study_middle),
																	_user$project$ViewGenerator$boolStudyLvl(job.study_end))),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															...
															{ctor: '[]'},
															{
																...
																_0: _elm_lang$html$Html$text(
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		_elm_lang$core$Basics$toString(job.payment),
																		A2(_elm_lang$core$Basics_ops['++'], ' ', job.currency))),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: A2(
																...
																{ctor: '[]'},
																{
																	...
																	_0: _elm_lang$html$Html$text(
																		A2(
																			_elm_lang$core$Basics_ops['++'],
																			_elm_lang$core$Basics$toString(job.weeksMin),
																			A2(
																				_elm_lang$core$Basics_ops['++'],
																				' - ',
																				A2(
																					_elm_lang$core$Basics_ops['++'],
																					_elm_lang$core$Basics$toString(job.weeksMax),
																					' uker')))),
																	_1: {ctor: '[]'}
																}),
															_1: {
																	...
																	{ctor: '[]'},
																	{
																		...
																		_0: _elm_lang$html$Html$text(
																			A2(
																				_elm_lang$core$Basics_ops['++'],
																				job.from,
																				A2(_elm_lang$core$Basics_ops['++'], ' til ', job.to))),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		...
																		{ctor: '[]'},
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(
																				_user$project$ViewGenerator$formatJobLanguages(job.languages)),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																				...
																				_0: _elm_lang$html$Html$text(
																					A2(
																						...
																						A2(
																							...
																							A2(
																								_elm_lang$core$Basics_ops['++'],
																								_elm_lang$core$Basics$toString(job.livingcost),
																								A2(_elm_lang$core$Basics_ops['++'], '/', job.livingcostFreq))))),
																				_1: {ctor: '[]'}
																			}),
																		_1: {
																			ctor: '::',
																			_0: A2(
																				...
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html$text(job.business),
																					_1: {ctor: '[]'}
																				}),
																			_1: {
																				ctor: '::',
																				_0: A2(
																					...
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html$text(job.trainingReq),
																						_1: {ctor: '[]'}
																					}),
																				_1: {ctor: '[]'}
																			}
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$html$Html_Attributes$attribute, 'id', 'job-table-2'),
							_1: {ctor: '[]'}
						}
					},
					{
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Flyplass'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Ansatte'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Arb.timer i uken'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Arb.timer daglig'),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Skatt av lønn'),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('Andre krav'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(job.airport),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text(job.employees),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: A2(
																...
																{ctor: '[]'},
																{
																	...
																	_0: _elm_lang$html$Html$text(
																		A2(
																			_elm_lang$core$Basics_ops['++'],
																			_elm_lang$core$Basics$toString(job.hoursWeekly),
																			' timer i uken')),
																	_1: {ctor: '[]'}
																}),
															_1: {
																...
																_0: A2(
																	...
																	{ctor: '[]'},
																	{
																		...
																		_0: _elm_lang$html$Html$text(
																			A2(
																				_elm_lang$core$Basics_ops['++'],
																				_elm_lang$core$Basics$toString(job.hoursDaily),
																				' timer dagen')),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(job.deduction),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
...
var _user$project$ViewGenerator$buildJobPreviewElement = function (job) {
	return A2(
		_elm_lang$html$Html$li,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('collapsible-header row waves-effect'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('country col s2'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(job.country),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('employer col s7'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(job.employer),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('collapsible-body'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('work-desc'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Jobbeskrivelse'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(job.workkind),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						_1: {
							ctor: '::',
							_0: _user$project$ViewGenerator$buildFullJobElement(job),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$ViewGenerator$buildDivs = function (list) {
	var _p3 = list;
	if (_p3.ctor === '::') {
		return {
			ctor: '::',
			_0: _user$project$ViewGenerator$buildJobPreviewElement(_p3._0),
			_1: _user$project$ViewGenerator$buildDivs(_p3._1)
		};
	} else {
		return {ctor: '[]'};
	}
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Filtrer jobber'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('z-depth-2'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Attributes$attribute, 'id', 'top-text'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('collapsible popout filter-class'),
									_1: {
										ctor: '::',
								...
								{
									ctor: '::',
									_0: _user$project$Main$buildFilterView(model),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									_user$project$ViewGenerator$buildDivs(model.currentJobs)),
								_1: {ctor: '[]'}
							}
						}
					}),
